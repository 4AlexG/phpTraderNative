...
// php-7.2 -dzend_extension=C:\PHP\xDebug\php_xdebug-2.6.0-7.2-vc15-nts-x86_64.dll -dxdebug.profiler_enable=1 -f bench.php
// php-7.3 -dzend_extension=C:\PHP\xDebug\php_xdebug-2.7.2-7.3-nts.dll -dxdebug.profiler_enable=1 bench.php
...
class bench
{
    ...
    public function __construct()
    {
        ...
        $this->rsi
            ->setPeriod($optInTimePeriod)
            ->setInputArray($this->High)
        ;
        $optInTimePeriod = 10;
...
$bench = new bench();
for ($i = 0; $i < $lim; $i++) {
    $bench->benchTaLib()->benchTraderStatic()->benchLupeTrader()->benchLupeTraderReuse();
}
